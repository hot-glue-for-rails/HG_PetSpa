...
describe "interaction for Admin::AppointmentsController", type: :feature do
  include HotGlue::ControllerHelper
  #HOTGLUE-SAVESTART
  #HOTGLUE-END
  
  let!(:pet1) {create(:pet)}
  let!(:appointment1) {create(:appointment , when_at: DateTime.current + rand(1000).seconds, 
      pet: pet1 )}
  ...
  describe "edit & update" do
    it "should return an editable form" do
      visit admin_appointments_path
      find("a.edit-appointment-button[href='/admin/appointments/#{appointment1.id}/edit']").click
  ...
  describe "destroy" do
    it "should destroy" do
      visit admin_appointments_path
      accept_alert do
        find("form[action='/admin/appointments/#{appointment1.id}'] > input.delete-appointment-button").click
      end
